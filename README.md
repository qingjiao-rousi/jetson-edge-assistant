...
| Q4_K_M / Q8_0 固定单图 | **已验证 E2E** | 同 clean commit 下 Runtime total median 为 1,530 / 1,462 ms；统一 RAM median 为 12,344.5 / 13,800 MB | [单图配对报告](benchmarks/q4-q8-image-paired-20260813.md)；不代表准确率，视觉阶段结构化计时仍未接通 |
