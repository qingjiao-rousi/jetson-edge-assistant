...
R2.1 is `PARTIAL` at milestone level because no independent holdout has been generated or run. The existing R2 holdout is not used, and this evaluator intentionally has no holdout option. No quality gate was reduced, no answer generation or M9.2 work was added, and these R2.1 changes remain uncommitted pending review.
