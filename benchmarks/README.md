...
Clean-commit Q4/Q8 locked-clock text and fixed single-image end-to-end summaries are checked in with reviewed aggregate numbers and SHA-256 bindings to local Git-ignored evidence. Structured vision-stage timing, VLM quality and stability results remain pending. Board telemetry rails are not wall power.
